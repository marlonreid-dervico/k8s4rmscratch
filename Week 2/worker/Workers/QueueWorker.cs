    ...
    public class QueueWorker
    {
        ...
        private void SaveVote(object sender, MsgHandlerEventArgs e)
        {
            ...
            try
            {
                ...
                _logger.LogDebug($"Successfully processed vote by '{voteMessage.VoterId}'");
            }
            catch (Exception ex)
            {
        ...
        public IConnection CreateConnection()
        {
            try
            {
                var url = _config.GetValue<string>("MessageQueue:Url");
                _logger.Log(LogLevel.Information, "about to create connection");
